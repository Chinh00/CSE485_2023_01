...
-- Thời gian đã tạo: Th2 24, 2023 lúc 06:23 PM
...
--
ALTER TABLE `baiviet`
  MODIFY `ma_bviet` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT cho bảng `tacgia`
--
ALTER TABLE `tacgia`
  MODIFY `ma_tgia` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT cho bảng `theloai`
--
ALTER TABLE `theloai`
  MODIFY `ma_tloai` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
